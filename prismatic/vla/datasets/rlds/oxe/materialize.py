...
def make_oxe_dataset_kwargs(
    ...
    if registry_name not in OXE_DATASET_CONFIGS:
        libero_bases = (
        ...
        if registry_name is None:
            raise KeyError(
                ...
                "in OXE_DATASET_CONFIGS"
            )

    dataset_kwargs = deepcopy(OXE_DATASET_CONFIGS[registry_name])
    ...
    dataset_kwargs["standardize_fn"] = OXE_STANDARDIZATION_TRANSFORMS[registry_name]
